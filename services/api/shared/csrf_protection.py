...
class CSRFMiddleware(BaseHTTPMiddleware):
    ...
    # Meta / dış provider webhook'ları CSRF token gönderemez (HMAC ile doğrulanır).
    ...
    async def dispatch(self, request: Request, call_next: Callable) -> Response:
        ...
        # Login + WhatsApp webhook: CSRF bootstrap / Meta POST bozulmasın.
        if request.method == "POST" and any(path.endswith(s) for s in self._CSRF_EXEMPT_SUFFIXES):
